        ...
        <?php endif ?>
            ...
            <div class="" style="margin-top:2em;">
                ...
                <table class="table table-striped alert alert-info">
                    ...
                    <th class="col-lg-6 col-md-6">Drug</th>
                    <th class="col-lg-3 col-md-3">Answered</th>
                        </tr>
  ...
  if($panswered == 1){
                 echo'           <tr>
                            ...
                            <td class="col-lg-10 col-md-10"><h5>'.$pdrug.'</h5></td>
                             <td class="col-lg-10 col-md-10"><h5>Answered</h5></td>
                        </tr>';
  }
 else {
                   echo'           <tr>
                            <td class="col-lg-2 col-md-2"><h5>'.$ptime.'</h5></td>
                            <td class="col-lg-10 col-md-10"><h5>'.$pdrug.'</h5></td>
                             <td class="col-lg-10 col-md-10"><form action="#" method="post"><button type="submit" name="canswered" value="'.$id.'" class="btn btn-info btn-sm"><h5>Answered</h5></button></form></td>
                        </tr>';    
 }
  }
}
