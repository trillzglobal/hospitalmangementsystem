...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="#navbarSupportedContent" aria-expand="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon">SideBar</span>
            </button>
...
<div class="col-lg-offset-3 col-sm-12" style="margin-top:-2em; margin-bottom:2em;">
                <h3><?php echo $psurname.', '.$pfirst_name.' '.$pother_name; ?> </h3>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-12" style="margin-bottom:0.5px ">
                     ...
                     NHIS CARD:<b><?php echo'<font color="green">'.$pnhis_card.'</font>'; ?></b>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12" style="">
                            ARMY NO:<b><?php echo $parmy_no; ?></b>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12" style="margin-bottom:2px ">
	...
	<?php 	unset($_SESSION["report_success"]);?>
        <?php endif ?>
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <table class="table table-striped alert alert-info table-responsive table-condensed">
                    <thead>
...
<div class="text-center">
 ...
 <div class="col-lg-12"><hr></div>           
            ...
            <div class="col-lg-6 col-md-6 col-sm-12" >
                <div class="col-lg-offset-4 col-md-offset-4" style="margin-bottom:2em;"> </div>
                <table class="table table-striped alert alert-info table-condensed table-responsive">
                    <thead>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                <div class="md-form mb-5">
                    <i class="fa fa-envelope prefix grey-text"></i>
                     <label data-error="wrong" data-success="right" for="defaultForm-email">Your ID:</label>
                     <input type="text" placeholder="<?php echo $_SESSION["username"];?>" class="form-control" readonly="readonly">
...
while($row = mysqli_fetch_assoc($asquare)){
  ...
  if($adischarged_status == 0){
               ...
               echo'<tr>
                            ...
                            <td class="col-lg-4 col-md-4">Still On Admission</td>
...
?>
                                    ...
                                    <div class="col-lg-12"><hr></div>
                                    <div class="col-lg-offset-4 col-lg-3 col-md-offset-3 col-md-3" style="padding-bottom: 5em">
                                        <form action="#" method="post" class="alert alert-warning">
                                            <button type="submit" name="done" class="btn btn-rounded bg-primary btn-lg">Done with Patient</button>
                                        </form>
                                    </div>
  <?php endif ?>
