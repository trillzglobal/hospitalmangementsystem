...
while($row = mysqli_fetch_assoc($square)){
  ...
  $ddoctor = $row['doctor'];
               ...
               echo'           <tr>
                            ...
                            <td class="col-lg-2 col-md-2"><h5>'.$ddoctor.'</h5></td>
                        </tr>';
            ...
            <div class="col-lg-12 col-md-12" style="">
                ...
                <table class="table table-striped alert alert-info">
                    ...
                    <caption class="col-lg-offset-5 col-md-offset-4"><font color="green"><b>ADMISSION STATUS</b></font></caption>
                        <tr>
                    <th class="col-lg-4 col-md-4">Date Admitted</th>
                    <th class="col-lg-4 col-md-4">Discharge Status</th>
                    <th class="col-lg-4 col-md-4">Discharged date</th>
...
while($row = mysqli_fetch_assoc($asquare)){
  ...
  if($adischarged_status == "0"){
               ...
               echo'<tr>
                            <td class="col-lg-4 col-md-4"><h5>'.$atime_admitted.'</h5></td>
                            <td class="col-lg-4 col-md-4"><form action="#" method="post"><button type="submit" name="ccode" value="'.$code.'">Discharge</button></form></td>
                            <td class="col-lg-4 col-md-4"><h5>'.$atime_discharged.'</h5></td>
                     ...
                     echo'<tr>
                            <td class="col-lg-4 col-md-4"><h5>'.$atime_admitted.'</h5></td>
                            <td class="col-lg-4 col-md-4">Discharged</td>
                            <td class="col-lg-4 col-md-4"><h5>'.$atime_discharged.'</h5></td>
...
?>
    ...
    <form method="post" action="#" enctype="multiform/data-file">
        ...
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold"><b><font color="green">ADMIT PATIENT</font></b></h4>
            ...
            <div class="modal-body mx-3">
                <div class="md-form mb-5">
                    <i class="fa fa-envelope prefix grey-text"></i>
                     ...
                     <input type="text" name="new_admission" value="<?php echo $ppatient_id;?>" class="form-control" readonly="readonly">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button type="submit" class="btn btn-default" name="submit_admission">Yes</button>
            </div>
        </div>
    </div>
    </form>
        ...
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold"><b><font color="green">ADD TO DOCTOR</font></b></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body mx-3">
                <div class="md-form mb-5">
                    <i class="fa fa-envelope prefix grey-text"></i>
                     <label data-error="wrong" data-success="right" for="defaultForm-email">Patient ID</label>
                     <input type="text"   name="to_doctor" value="<?php echo $ppatient_id;?>" class="form-control" readonly="readonly">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button type="submit" class="btn btn-default" name="send_to_doctor">Send To Doctor</button>
            </div>
        </div>
    </div>
                    </form>
    ...
    <a href="" class="btn btn-danger btn-rounded mb-4" data-toggle="modal" data-target="#modalLoginForm1">Admit Patient</a>
</div>
            <div class="col-lg-3 col-md-3">
    <a href="" class="btn btn-danger btn-rounded mb-4" data-toggle="modal" data-target="#modalLoginForm">Send to Doctor</a>
</div>
